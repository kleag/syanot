...
#ifndef SYANOT_PASSAGEFORM_H
#define SYANOT_PASSAGEFORM_H
 ...
 */
class PassageToken : public PassageConstituent
{
  Q_OBJECT
public:
  /**
    * Default Constructor
    */
  PassageToken(PassageUtterance* parent);

  /**
    * Default Destructor
    */
  virtual ~PassageToken();
