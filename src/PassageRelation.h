...
#ifndef SYANOT_PASSAGERELATION_H
#define SYANOT_PASSAGERELATION_H
 ...
 */
class PassageRelation : public QObject
{
  Q_OBJECT
public:
  /**
...
QTextStream& operator<<(QTextStream& s, const PassageRelation& r);
